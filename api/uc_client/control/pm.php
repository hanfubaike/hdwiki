...
define('PMLIMIT1DAY_ERROR', -1);//note 超出了24小时最大允许发送短消息数目
define('PMFLOODCTRL_ERROR', -2);//note 不满足两次发送短消息最短间隔
define('PMMSGTONOTFRIEND', -3);//note 群发短消息，但是目标并非发信者好友
define('PMSENDREGDAYS', -4);//note 发短消息最少注册天数
