...
INSERT INTO wiki_channel VALUES 	(1, '首页', '/index.php', 0, 1, 2),
									(2, '百科分类', '/index.php?category', 1, 1, 2),
									(3, '排行榜', '/index.php?list', 2, 1, 2),
									(4, '图片百科', '/index.php?pic-piclist-2', 3, 1, 2),
									(5, '礼品商店', '/index.php?gift', 4, 1, 2);								   
EOT;
